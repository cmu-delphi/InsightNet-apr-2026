...
NOTE: this is why, for serious applications, we want to use
`epi_archive`s and `epix_as_of` or `epix_slide` rather than the
filtering approach above, in order to faithfully reflecting reflecting
the data that would have been fed into a model and how the model would
have behaved.
